  ...
  return (
    <div className="epg-page">
      ...
      <div className="epg-topbar">
        ...
        >
          <img src={`${BASE}icons/jpl.png`} alt="" width="28" height="28" className="jpl-btn-icon" /> JPL
        </button>
        <button
  ...
  return (
    <div className="sheet-backdrop" onClick={onClose}>
      <div className="sheet sport-sheet" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
        <div className="grabber" />
        <h3>
          {jplOnly && <img src={`${BASE}icons/jpl.png`} alt="" width="28" height="28" className="jpl-panel-icon" />}
